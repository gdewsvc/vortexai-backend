...
async def buyer_webhook(payload: BuyerSubmission, request: Request):
    await db_exec("""
...
async def seller_webhook(payload: SellerSubmission, request: Request):
    await db_exec("""
